            ...
            return {
                rules: {
                    name: [
                        ...
                        { pattern: /^[\u4E00-\u9FA5\\s]{2}$|^[\u4E00-\u9FA5\\s]{3}$|^[\u4E00-\u9FA5\\s]{4}$|^[\u4E00-\u9FA5\\s]{5}$/, message: '格式错误,请输入2-5个汉字',trigger:'blur' }
                    ],
                    birthday: [
                        {required: true, message: '出生日期不可为空', trigger: 'blur'},
                        {type: 'date', message: '出生日期格式不正确', trigger: 'blur'}
                    ],
                    nativePlace: [
                        {required: true, message: '籍贯不可为空', trigger: 'blur'},
                    ],
                    email:[
                        {type:'email',message:'电子邮件格式不对',trigger:'blur'}
                    ],
                    idCard:[
                        { pattern: /^34[0-9]{12}X$|^34[0-9]{16}$/, message: '身份证号码格式错误',trigger:'blur' }
                    ]
